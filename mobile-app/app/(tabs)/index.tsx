...
import { buildWeeklySummary, WeeklySummary } from "../../utils/weeklySummary";
...
export default function App() {
  ...
  const [cloudStatus, setCloudStatus] = useState<CloudTuningResponse | null>(
    null
  );
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.navRow}>
          ...
          <Pressable
            style={[styles.button, !previousVisited && styles.buttonDisabled]}
            onPress={goNext}
...
const CloudTuningCard = ({
  ...
  <View style={styles.card}>
    ...
    {!loading && !status && (
      <Text style={styles.cardBody}>
        Cloud tuning available when you reach today.
      </Text>
    )}
  </View>
);

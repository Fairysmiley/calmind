...
import { RiskConfig, RiskInsight, WeatherDay, WellbeingDay } from "../types";

export class RiskEngine {
  constructor(
    private config: RiskConfig,
    private weather: WeatherDay[]
  ) {}
  ...
  private buildRecommendation(drivers: string[], action: RiskInsight["action"]) {
